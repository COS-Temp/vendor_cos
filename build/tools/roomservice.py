...
gzosp_manifest = ".repo/manifests/manifests/gzosp.xml"
custom_local_manifest = ".repo/local_manifests/cosmic_manifest.xml"
custom_default_revision = "corona-release"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    gzospm = load_manifest(gzosp_manifest)
	...
	existing_m_project = None
        ...
        elif exists_in_tree(gzospm, repo_target) != None:
	    existing_m_project = exists_in_tree(gzospm, repo_target)
